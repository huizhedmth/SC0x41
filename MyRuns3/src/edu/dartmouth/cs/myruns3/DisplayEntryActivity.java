...
public class DisplayEntryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		EditText text1 = (EditText) findViewById(R.id.edit_display_activity_type);
		EditText text2 = (EditText) findViewById(R.id.edit_display_date_time);
		EditText text3 = (EditText) findViewById(R.id.edit_display_duration);
		EditText text4 = (EditText) findViewById(R.id.edit_display_distance);
		EditText text5 = (EditText) findViewById(R.id.edit_display_calorie);
		EditText text6 = (EditText) findViewById(R.id.edit_display_heart_rate);
		EditText text7 = (EditText) findViewById(R.id.edit_display_comment);
