...
public class HistoryFragment extends ListFragment 
	...
	public final String[] activityTypeTable = new String[] {       
	"Running",
    "Cycling",
    "Walking",
    "Hiking",
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		int idx = mActivityEntryCursor.getColumnIndex(Globals.KEY_ROWID);
		...
		idx = mActivityEntryCursor.getColumnIndex(Globals.KEY_INPUT_TYPE);
	...
	private class ActivityEntriesCursorAdapter extends CursorAdapter {
		...
		public void bindView(View view, Context context, Cursor cursor) {
	        ...
	        String line1, line2;
				...
				line1 = activityTypeTable[code].substring(0);
				line1 = line1 + ", ";
