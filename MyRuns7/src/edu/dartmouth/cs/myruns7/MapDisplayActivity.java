...
import edu.dartmouth.cs.myruns7.TrackingService.TrackingBinder;
...
public class MapDisplayActivity extends Activity {
	...
	public class MotionUpdateReceiver extends BroadcastReceiver{
		@Override
		public void onReceive(Context context, Intent intent){
			String type = Globals.TYPE_STATS + Globals.ACTIVITY_TYPES[intent.getIntExtra(TrackingService.NEW_MOTION_TYPE, -1)];
			typeStats.setText(type);
		}
	}
